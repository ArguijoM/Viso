...
public class InstruccionFragment3 extends Fragment {
    private FragmentInstruccion3Binding binding;
    private TextView text,text2;
    private ImageView img,img2,img3;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentInstruccion3Binding.inflate(inflater,container, false);
