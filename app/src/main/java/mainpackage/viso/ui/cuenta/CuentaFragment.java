...
public class CuentaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if(bundle!=null){
            id = bundle.getInt("id");
            this.usuarioActual = SharedPreferencesHelper.getUsuarioByIdLocal(getActivity(),id);
            SharedPreferencesHelper.setUsuarioActual(getActivity(),usuarioActual);
        }else{
            this.usuarioActual = SharedPreferencesHelper.getUsuarioActual(getActivity());
        }
        ...
        if(usuarioActual.getActividades()==null){
            ...
            realizadas = usuarioActual.getActividades().size();faltantes=Herramientas.TOTAL_ACT-realizadas;
        ...
        btn_cambiar_usuario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferencesHelper.updateUsuariobyId(getActivity(),usuarioActual);
